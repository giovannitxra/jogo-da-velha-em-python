...
pts_jogador = 0
pts_pc = 0
# Repete toda vez que o jogo é finalizado!
while True:
...
_____|_____|_____
  ...
  7  |  8  |  9  
    ...
    while primeiro != 'EU' and primeiro != 'VC':
        instr = 'Digite EU e pressione Enter para você começar, ou digite VC e pressione Enter para eu começar: '
